<script src="{{ asset('backends/assets/js/core/jquery.3.2.1.min.js') }}"></script>
...
<!-- jQuery UI -->
<script src="{{ asset('backends/assets/js/plugin/jquery-ui-1.12.1.custom/jquery-ui.min.js') }}"></script>
...
<!-- Moment JS -->
<script src="{{ asset('backends/assets/js/plugin/moment/moment.min.js') }}"></script>
...
<!-- Bootstrap Toggle -->
<script src="{{ asset('backends/assets/js/plugin/bootstrap-toggle/bootstrap-toggle.min.js') }}"></script>

<!-- jQuery Vector Maps -->
<script src="{{ asset('backends/assets/js/plugin/jqvmap/jquery.vmap.min.js') }}"></script>
<script src="{{ asset('backends/assets/js/plugin/jqvmap/maps/jquery.vmap.world.js') }}"></script>

<!-- Google Maps Plugin -->
<script src="{{ asset('backends/assets/js/plugin/gmaps/gmaps.js') }}"></script>

<!-- Sweet Alert -->
<script src="{{ asset('backends/assets/js/plugin/sweetalert/sweetalert.min.js') }}"></script>

<!-- Azzara JS -->
<script src="{{ asset('backends/assets/js/ready.min.js') }}"></script>
