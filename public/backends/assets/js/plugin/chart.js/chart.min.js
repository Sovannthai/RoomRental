          ...
          (c.prototype.parseOptions = function (a) {
              ...
              return b
                  ? ((this.chartInstance = a),
                    ...
                    (this.fontSize =
                        b.fontSize || this.options.defaultFontSize),
                    (this.fontColor =
                        b.fontColor || this.options.defaultFontColor),
                    (this.fontStyle =
                        b.fontStyle || this.options.defaultFontStyle),
                    (this.fontFamily =
                        b.fontFamily || this.options.defaultFontFamily),
                    (this.hasTooltip =
                        a.tooltip._active && a.tooltip._active.length),
                    (this.showZero = b.showZero),
                    (this.overlap = b.overlap),
                    (this.images = b.images || []),
                    (this.showActualPercentages =
                        b.showActualPercentages || !1),
                    !0)
                  : !1;
          }),
